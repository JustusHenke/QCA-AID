...
class LLMProviderFactory:
    ...
    def create_provider(
        ...
        Args:
            ...
            base_url: Optional - Base URL (für 'openai' und 'local' Provider)
            api_key_env: Optional - Name der Umgebungsvariable für den API-Key
                          (z.B. 'GWDG_API_KEY', 'CUSTOM_API_KEY').
                          Nur für 'openai' Provider mit base_url relevant.
        ...
        Example:
            ...
            >>>
            >>> # Create OpenAI-compatible provider with custom URL (e.g., GWDG)
            >>> gwdg_provider = factory.create_provider('openai', base_url='https://chat-ai.academiccloud.de/v1')
            >>>
        ...
        try:
            ...
            if provider_name in ["openai", "gpt"]:
                provider = OpenAIProvider(base_url=base_url, api_key_env=api_key_env)
