...
**NEU in Version 0.12.x**: QCA-AID bietet jetzt eine vollständige webbasierte Benutzeroberfläche!
...
Henke, J. (2025). QCA-AID: Qualitative Content Analysis with AI-supported Discovery (Version 0.12.2) [Software]. 
